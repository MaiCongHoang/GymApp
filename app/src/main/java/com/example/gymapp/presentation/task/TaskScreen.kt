...
import com.example.gymapp.presentation.components.TaskCheckBox
import com.example.gymapp.presentation.components.TaskDatePicker
...
private fun TaskScreen(
    ...
    taskTitleError = when {
        state.title.isBlank() -> "Vui lòng nhập tiêu đề nhiệm vụ."
        state.title.length < 4 -> "Tiêu đề nhiệm vụ quá ngắn."
        state.title.length > 30 -> "Tiêu đề nhiệm vụ quá dài."
        else -> null
    }
    ...
    DeleteDialog(
        ...
        title = "Xoá Nhiệm Vụ?",
        bodyText = "Bạn có chắc chắn muốn xóa tác vụ này? " +
            ...
            Row(
                ...
                IconButton(onClick = { isDatePickerDialogOpen = true }) {
                    Icon(
                        ...
                        contentDescription = "Chọn Ngày Hoàn Thành"
                    )
                }
            }
            Spacer(modifier = Modifier.height(10.dp))
            ...
            if (isTaskExist) {
                ...
                IconButton(onClick = onDeleteButtonClick) {
                    Icon(
                        ...
                        contentDescription = "Xoá Nhiệm Vụ"
                    )
                }
            }
        }
