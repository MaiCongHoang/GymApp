...
import com.example.gymapp.presentation.components.SubjectListBottomSheet
import com.example.gymapp.presentation.components.studySessionsList
import com.example.gymapp.presentation.theme.Red
import com.example.gymapp.util.Constants.ACTION_SERVICE_CANCEL
import com.example.gymapp.util.Constants.ACTION_SERVICE_START
import com.example.gymapp.util.Constants.ACTION_SERVICE_STOP
...
private fun SessionScreen(
    ...
    DeleteDialog(
        ...
        title = "Xóa Buổi Tập?",
        bodyText = "Bạn có chắc chắn muốn xóa buổi tập này? " +
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            studySessionsList(
                sectionTitle = "LỊCH SỬ CÁC BUỔI TẬP",
...
private fun SessionScreenTopBar(
    ...
    TopAppBar(
        ...
        title = {
            Text(text = "Buổi Tập", style = MaterialTheme.typography.headlineSmall)
        }
    )
}
